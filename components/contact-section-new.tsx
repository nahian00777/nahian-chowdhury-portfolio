...
import { sendEmailAction } from '@/lib/send-message'
...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    // Call the action and capture the returned object
    ...
    if (result.success) {
      ...
      // Show the specific error from Resend
